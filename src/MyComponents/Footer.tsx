      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap items-center justify-center gap-4 text-gray-400">
          <div className="flex items-center">
            <span className="text-blue-500 font-bold">{n("company.knoz")}</span>
            <span className="mx-1 font-bold">|</span>
            <span className="text-red-500 font-bold">{n("company.orion")}</span>
          </div>

          <span className="h-4 w-px bg-gray-700 hidden md:block"></span>

          <p>
            &copy; {new Date().getFullYear()} {n("company.knoz")} |{" "}
            {n("company.orion")}. {t("rights")}
          </p>
